        ...
        if (tab === 'coins') {
            ...
            content.innerHTML = `
                ...
                <ul>
                    ...
                    <li>Организация в корпоративном мероприятии (субботник, благотворительность): <strong>+20 Bus‑коинов</strong></li>
                    <li>Участие в корпоративных мероприятиях: <strong>+1 и выше Bus‑коинов</strong></li>
                </ul>
